...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, Test2_LED_Pin|Test1_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LD3_GPIO_Port, LD3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : Test2_LED_Pin Test1_LED_Pin */
  GPIO_InitStruct.Pin = Test2_LED_Pin|Test1_LED_Pin;
